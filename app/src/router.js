...
module.exports = function(GulpAngularGenerator) {
  ...
  GulpAngularGenerator.prototype.computeRouter = function computeRouter() {
    var routerPartialSrc = 'src/app/components/home/partials/__' + this.props.ui.key + '.html';

    if (this.props.router.module === 'ngRoute') {
      this.routerHtml = '<div ng-view></div>';
      this.files.push({
        src: 'src/app/_ngroute/__ngroute.' + this.props.jsPreprocessor.srcExtension,
        dest: 'src/app/components/home/home.config.' + this.props.jsPreprocessor.extension,
        template: true
      });
